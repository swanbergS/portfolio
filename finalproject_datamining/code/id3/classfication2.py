...
col_names = ['country','year', 'precipitation', 'temp', 'cancer', 'deaths from asthma', 'mental health', 'population', 'label']
# load dataset
data = pd.read_excel("dataset.xlsx", header=None, names=col_names)

#split dataset in features and target variable
feature_cols = ['country', 'year', 'precipitation', 'temp', 'cancer', 'deaths from asthma', 'mental health', 'population']
